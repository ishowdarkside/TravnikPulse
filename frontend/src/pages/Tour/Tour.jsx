    ...
    return (
        <>
            ...
            <div className={styles.tour}>
                <div className={styles.image} style={{ backgroundImage: `url('http://127.0.0.1:8000/${data.coverImg}')` }}>
                ...
                {!showReview ? <AboutTour setShowReview={setShowReview} data={data} /> :  <ReviewTour /> }
            </div>
        </>
    )
}